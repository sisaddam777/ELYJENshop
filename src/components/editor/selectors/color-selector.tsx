        ...
        <Popover open={open} onOpenChange={onOpenChange}>
            <PopoverTrigger
                className={cn(
                    ...
                    "gap-2 rounded-none aria-expanded:bg-accent"
                )}
            >
                <span
            ...
            <PopoverContent
                side="bottom"
                sideOffset={12}
                className="z-[99999] my-1 flex max-h-80 w-48 flex-col overflow-hidden overflow-y-auto rounded border p-1 shadow-xl"
                align="start"
            >
