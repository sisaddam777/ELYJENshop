        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 pt-6 border-t">
          ...
          {whatsappNumber && (
            <Button
              size="lg"
              variant="outline"
              className="flex-1 h-12 rounded-full font-bold uppercase tracking-wider border-[#25D366] text-[#25D366] hover:bg-[#25D366] hover:text-white transition-all hover:scale-[1.02]"
              onClick={() => window.open(`https://wa.me/${whatsappNumber.replace(/[^0-9]/g, '')}?text=Hi, I'm interested in ${product.name}`, '_blank')}
            >
