...
export function ScrollToTop() {
  ...
  return (
    <div className="fixed bottom-4 right-3 z-50 md:bottom-6 md:right-4 flex flex-col gap-3">
        ...
        {whatsappNumber && (
          ...
          >
             ...
             <Button
                ...
                size="icon"
                className="rounded-full shadow-2xl h-10 w-10 md:h-12 md:w-12 bg-[#25D366] hover:bg-[#20ba5a] text-white border-2 border-white transition-all"
